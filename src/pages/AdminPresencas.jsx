                ...
                <CardContent className="p-3">
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className={`w-10 h-10 rounded-full flex-shrink-0 flex items-center justify-center transition-colors ${p.presente ? "bg-green-500 text-white" : "bg-slate-100 text-slate-400 hover:bg-slate-200"}`}
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2 flex-wrap">
                        ...
                        <Badge className={`flex-shrink-0 ${p.presente ? "bg-green-100 text-green-800" : "bg-red-100 text-red-700"}`}>
