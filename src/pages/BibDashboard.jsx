        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Link 
              ...
              className="text-sm text-lodge-navy hover:underline flex items-center gap-1"
            >
            ...
            {emprestimosRecentes.length === 0 ? (
              ...
              <div className="space-y-3">
                {emprestimosRecentes.map((emp) => (
                  <div key={emp.id} className="flex items-center justify-between p-3 bg-muted rounded-xl">
                    <div>
                      <p className="font-medium text-foreground">{emp.item_nome}</p>
                      <p className="text-sm text-muted-foreground">{emp.irmao_nome}</p>
                    </div>
          ...
          <CardContent>
            {atrasados.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">Nenhum empréstimo atrasado!</p>
              </div>
            ) : (
              <div className="space-y-3">
                {atrasados.map((emp) => (
